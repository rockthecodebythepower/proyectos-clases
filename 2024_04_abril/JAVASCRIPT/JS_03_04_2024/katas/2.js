...
// quiero mostrar por consola el mensaje de la solución
const objeto = {
  propiedad1: [
    ,
    ,
...
console.log(objeto.propiedad1[4].propiedad2.propiedad3[0][0][1][0].solucion);

/* const alumno = {
    nombre: "Carlos",
    apellido: "Escribano",
    array: [23, 32, 32, 23, 324]
}

console.log(alumno.nombre);
console.log(alumno.array[4]); */
